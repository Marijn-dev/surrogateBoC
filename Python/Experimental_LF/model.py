...
class LF_model(nn.Module):
    ...
    def __init__(self, par):
        ...
        self.u_rnn = torch.nn.LSTM(
            input_size= par.N_r + 3,  # added 1 for the delta, and 2 for additional properties of the input
...
class PHYS_model(nn.Module):
    ...
    def forward(self, r, u, delta_window):  
        ...
        for l in range(delta_window.shape[0]):
            if (delta_window[l]>=u[l,-3]) and (delta_window[l]<=(u[l,-3]+u[l,-2])):
