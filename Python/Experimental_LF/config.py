...
class Config:
    def __init__(self):     
        ...
        self.shed_patience = 10 #number of epochs with no improvement after which learning rate will be reduced
        self.es_delta = 0.0001 #minimum change to consider as an improvement
        self.es_patience = 100 #number of epochs with no improvement after which training will be stopped
        ...
        # self.folder_datasets = f"./datasets_generalisation_sim9"
