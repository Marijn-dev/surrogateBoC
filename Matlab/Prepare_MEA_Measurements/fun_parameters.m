...
pm.save.folder = ['Figures/' pm.n_MEA '/' pm.file_name '/'];
pm.save.saveBool = true;
if ~exist(pm.save.folder, 'dir') && pm.save.saveBool
   mkdir(pm.save.folder)
end
